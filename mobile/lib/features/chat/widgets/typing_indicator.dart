...
/// Helper widget that rebuilds on animation ticks, like AnimatedBuilder.
class AnimatedBuilder extends StatelessWidget {
  ...
  /// Private constructor used by the build method — delegates to
  /// Flutter's built-in [AnimatedBuilder].
