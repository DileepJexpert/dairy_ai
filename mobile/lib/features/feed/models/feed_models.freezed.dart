...
mixin _$FeedIngredient {
  ...
  /// Serializes this FeedIngredient to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of FeedIngredient
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      costPerKg: null == costPerKg
          ? _value.costPerKg
          : costPerKg // ignore: cast_nullable_to_non_nullable
              as double,
...
class _$FeedIngredientImpl implements _FeedIngredient {
  ...
  int get hashCode => Object.hash(
      runtimeType, name, quantityKg, costPerKg, totalCost, category);
  ...
  Map<String, dynamic> toJson() {
    return _$$FeedIngredientImplToJson(
      this,
    );
  }
}
...
mixin _$FeedPlan {
  ...
  /// Serializes this FeedPlan to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of FeedPlan
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
    ...
    return _then(_value.copyWith(
      ...
      ingredients: null == ingredients
          ...
          : ingredients // ignore: cast_nullable_to_non_nullable
              as List<FeedIngredient>,
      costPerDay: null == costPerDay
          ? _value.costPerDay
          : costPerDay // ignore: cast_nullable_to_non_nullable
              as double,
      totalDmKg: freezed == totalDmKg
          ? _value.totalDmKg
          : totalDmKg // ignore: cast_nullable_to_non_nullable
              as double?,
      totalCpPct: freezed == totalCpPct
          ? _value.totalCpPct
          : totalCpPct // ignore: cast_nullable_to_non_nullable
              as double?,
      ...
      savingsVsCurrent: freezed == savingsVsCurrent
          ...
          : savingsVsCurrent // ignore: cast_nullable_to_non_nullable
              as double?,
...
mixin _$CattleRef {
  ...
  /// Serializes this CattleRef to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of CattleRef
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
