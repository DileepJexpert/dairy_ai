...
const defaultMilterraProducts = <Product>[
  ...
  Product(
    id: 'mil-milk-fresh-1l',
    vendorId: 'vendor-milterra-dairy',
    title: 'MILTERRA Pure A2 Gir Cow Raw Chilled Milk',
    category: ProductCategory.feedNutrition,
    price: 95,
    compareAtPrice: 110,
    unit: 'bottle',
    ...
    packSize: '1 Litre',
    description:
        'Farm-fresh, non-homogenized pure A2 Gir Cow raw chilled milk. Sourced from grass-fed indigenous cows and packaged in eco-friendly glass bottles.',
    taxonomy: {
      'department_name': 'Dairy Foods',
      'category_name': 'Milk',
      'department_id': 'dairy-foods',
      'category_id': 'milk-fresh',
      'status': 'In Stock',
    },
    media: [
      'assets/store/farm-pasture.jpg',
    ...
    minOrderQuantity: 1,
    specifications: {
      'Breed': '100% Pure Indigenous Gir Cows',
      'Processing': 'Chilled at 4°C directly post milking (Non-Homogenized)',
  ...
  Product(
    id: 'mil-chhachh-500',
    vendorId: 'vendor-milterra-dairy',
    title: 'MILTERRA Traditional Masala Chhachh (Spiced Buttermilk)',
    category: ProductCategory.feedNutrition,
    price: 45,
    compareAtPrice: 55,
    unit: 'bottle',
    ...
    packSize: '500 ml',
    description:
        'Refreshing Vedic spiced buttermilk churned from natural A2 whole curd and seasoned with roasted cumin, rock salt, ginger, and fresh mint.',
    taxonomy: {
      'department_name': 'Dairy Foods',
      'category_name': 'Chhachh & Buttermilk',
      'department_id': 'dairy-foods',
      'category_id': 'chhachh-buttermilk',
      'status': 'In Stock',
    },
    media: [
      'assets/store/farm-bilona.jpg',
    ...
    minOrderQuantity: 1,
    specifications: {
      'Base': 'Whole A2 Cultured Curd',
      'Spices': 'Roasted Jeera, Sendha Namak, Mint, Ginger',
      'Probiotics': 'Natural live lactic acid bacteria cultures',
      'Shelf Life': '3 Days (Keep Refrigerated)',
      'Country of Origin': 'India',
    },
  ),
  Product(
    id: 'mil-agarbatti-chandan',
    vendorId: 'vendor-milterra-dairy',
    title: 'MILTERRA Sacred Desi Cow Dung Agarbatti (Chandan & Rose)',
    category: ProductCategory.feedNutrition,
    price: 185,
    compareAtPrice: 230,
    unit: 'box',
    brand: 'MILTERRA',
    packSize: 'Pack of 100 Sticks',
    description:
        '100% charcoal-free, organic cow-dung incense sticks infused with natural sandalwood paste and pure damask rose petals. Pure, divine, and soothing satvik aroma.',
    taxonomy: {
      'department_name': 'Puja & Hawan Samagri',
      'category_name': 'Natural Dhoop & Agarbatti',
      'department_id': 'puja-hawan-samagri',
  ...
  Product(
    id: 'mil-oil-sarso-1l',
    vendorId: 'vendor-milterra-earth',
    title: 'MILTERRA Wood-Pressed Kachi Ghani Sarso (Mustard) Oil',
    category: ProductCategory.feedNutrition,
    price: 245,
    compareAtPrice: 299,
    unit: 'bottle',
    ...
    description:
        'Traditional wooden Kolhu / Kachi Ghani cold-pressed from farm-grown yellow & black mustard seeds. 100% unrefined, rich in Omega-3 and natural pungency.',
    taxonomy: {
      'department_name': 'Cold-Pressed Oils',
      'category_name': 'Mustard Oil',
      'department_id': 'cold-pressed-oils',
      'category_id': 'mustard-oil',
      'status': 'In Stock',
    },
    media: [
      'assets/store/cow-ghee.png',
    ...
    minOrderQuantity: 1,
    specifications: {
      'Extraction Method': 'Traditional Wooden Kolhu (Cold-Pressed at < 40°C)',
      'Raw Material': '100% Organically Cultivated Mustard (Sarso) Seeds',
      'Refining': 'Unrefined, Chemical-Free, Zero Argemone Oil',
      'Packaging': 'Food-grade Amber Glass Bottle',
      'Shelf Life': '12 Months',
      'Country of Origin': 'India',
    },
  ),
  Product(
    ...
    unit: 'tin',
    brand: 'MILTERRA',
    packSize: '5 Litre Heritage Tin',
    description:
        'Family pack of pure wood-pressed Kachi Ghani Mustard oil in a traditional food-grade tin canister. Perfect for authentic daily Indian cooking and pickles.',
    taxonomy: {
      'department_name': 'Cold-Pressed Oils',
      'category_name': 'Mustard Oil',
      'department_id': 'cold-pressed-oils',
    ...
    minOrderQuantity: 1,
    specifications: {
      'Extraction Method': 'Wood-Pressed Kolhu Cold Extraction',
      'Format': '5 Litre Food-Grade Canister',
      'Purity': '100% Pure Virgin Mustard Oil',
      'Shelf Life': '12 Months',
      'Country of Origin': 'India',
    },
  ),
